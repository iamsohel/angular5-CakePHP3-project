      ...
      data: {
        ...
        source: {
          read: {
            // sample GET method
            method: 'GET',
            url: this.config.apiEndPoint + 'employees/index?token=' + this.authS.getToken(),
      ...
      columns: [
        ...
        },
        {
          ...
          template: function(row) {
            if (row.thumb_image !== '' && row.thumb_image != null) {
              return '<img class="img-fluid img-avatar img-thumbnail" style="max-width:40px" src="' + row.thumb_image + '">';
            } else {
